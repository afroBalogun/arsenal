...
const Asante : React.FC<Props> = ({screenHeight}) => {
    ...
    return(
        <div className="h-screen asante-container">
            <img src="static/images/asante.png" alt="Asante" 
                className="relative h-full left-[20%] asante"
            />
            <img src="static/images/asante-text.png" alt="Asante-text" 
                className="relative h-full neg"
                style={{ top: `-${screenHeight}px` }}

            />
            <img src="static/images/carter.png" alt="Carter" 
                className="relative h-full pos"
                style={{ top: `-${2*screenHeight}px` }}

            />
            <img src="static/images/philip.png" alt="Philip" 
                className="relative h-full neg"
                style={{ top: `-${3*screenHeight}px` }}

            />
            <img src="static/images/sanderson.png" alt="Sanderson" 
                className="relative h-full pos"
                style={{ top: `-${4*screenHeight}px` }}

            />
            <img src="static/images/scott.png" alt="Scott" 
                className="relative h-full neg"
                style={{ top: `-${5*screenHeight}px` }}

            />
            <img src="static/images/yankey-text.png" alt="Yankey-text" 
                className="relative h-full pos"
